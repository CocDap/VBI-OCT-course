...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn do_something(origin: OriginFor<T>, something: u32) -> DispatchResult {
			...
			let free_balance = T::LocalCurrency::free_balance(&who).saturated_into::<u64>();
			let value = total_balance.saturated_into::<u64>();
			...
			Self::deposit_event(Event::FreeBalance(free_balance));
